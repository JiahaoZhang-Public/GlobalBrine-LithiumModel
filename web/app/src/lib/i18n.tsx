...
const messages: Record<Lang, Messages> = {
  en: {
    ...
    "landing.card1.desc": "Explore modeled selectivity, lithium flux, and evaporation across all brine points with chemistry filters and hover details.",
    ...
    "datasets.version": "CSV files from the latest build (v0.3.0).",
    ...
    "datasets.pred.desc": "Includes raw features, imputed features, and model outputs (selectivity, lithium flux, evaporation).",
    ...
    "map.subtitle": "Visualize predicted selectivity, lithium flux, and evaporation across all known brine sites.",
    ...
    "map.option.selectivity": "Li⁺/Mg²⁺ selectivity (unitless)",
    "map.option.crystallization": "Li⁺ flux (mg m⁻² h⁻¹)",
    "map.option.evap": "Evaporation rate (kg m⁻² h⁻¹)",
    "map.legend": "Teal → magenta shows low → high. Hover to see exact numbers and units.",
    "map.sample": "Sample",
    "single.title": "Single-Point Prediction",
    "single.subtitle": "Enter one brine sample. Missing fields can be imputed. Units: g L⁻¹ for chemistry, kW m⁻² for irradiance.",
    ...
    "single.stat.selectivity": "Li⁺/Mg²⁺ selectivity",
    "single.stat.helper": "Li⁺ vs Mg²⁺",
    "single.stat.crystallization": "Li⁺ flux",
    "single.stat.evap": "Evaporation rate",
    ...
    "model.valid.desc": "Chemistry in g L⁻¹; irradiance in kW m⁻². Typical training domain: TDS 10–400 g L⁻¹, MLR 0–25, Light 0.05–1.0. Outside these ranges, interpret with caution.",
    "model.use": "Intended use",
    "model.use.desc": "For screening and ranking brine sites; not a substitute for lab flux measurements. Partial inputs are allowed; missing chemistry may be imputed if enabled.",
  ...
  zh: {
    ...
    "landing.card1.desc": "按化学过滤并悬停查看详情，浏览选择性、锂通量与蒸发预测。",
    ...
    "map.title": "全球地图探索",
    "map.subtitle": "查看已知卤水站点的选择性、锂通量与蒸发预测。",
    "map.meta.points": "样点数",
    ...
    "map.color.by": "着色依据",
    "map.option.selectivity": "Li⁺/Mg²⁺ 选择性（无量纲）",
    "map.option.crystallization": "Li⁺ 通量 (mg m⁻² h⁻¹)",
    "map.option.evap": "蒸发速率 (kg m⁻² h⁻¹)",
    ...
    "single.stat.selectivity": "Li⁺/Mg²⁺ 选择性",
    "single.stat.helper": "Li⁺ 对 Mg²⁺",
    "single.stat.crystallization": "Li⁺ 通量",
    "single.stat.evap": "蒸发速率",
    ...
    "model.use": "预期用途",
    "model.use.desc": "用于卤水站点评估与排序；不能替代实验锂通量测试。支持部分输入，缺失可插补。",
    "model.limits": "已知局限",
    ...
    "landing.team.title": "团队",
    "landing.team.site": "主页",
    "lang.toggle": "EN",
    "lang.toggle.zh": "中文",
  },
};
